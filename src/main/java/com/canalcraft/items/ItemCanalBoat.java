...
public class ItemCanalBoat extends ItemBoat {

	public ItemCanalBoat(Type i) {
		super(EntityBoat.Type.OAK);
		this.setCreativeTab(Canalcraft.tabCanalcraft);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                EntityCanalBoat entityboat = new EntityCanalBoat(worldIn, raytraceresult.hitVec.xCoord, flag1 ? raytraceresult.hitVec.yCoord - 0.12D : raytraceresult.hitVec.yCoord, raytraceresult.hitVec.zCoord);
